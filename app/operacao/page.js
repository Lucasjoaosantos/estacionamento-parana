...
export default function OperacaoPage() {
  ...
  const [buscaAtiva, setBuscaAtiva] = useState(false); // controla se o teclado virtual da busca está aberto
  ...
  // campo o operador tocou por último. Os campos são "readOnly": só é
  // possível digitar usando o teclado virtual (o teclado físico do PC
  // fica bloqueado nesses campos).
      ...
      <main className="min-h-screen flex flex-col items-center px-4 sm:px-6 py-6 sm:py-8 gap-4 sm:gap-6">
        ...
        <div className="w-full max-w-2xl flex flex-col gap-3">
          ...
          <input
            ...
            className={`w-full px-4 py-3 sm:py-4 rounded-xl2 border-2 bg-surface text-2xl sm:text-4xl font-black tracking-widest text-center cursor-default
          ...
          <input
            ...
            className={`w-full px-4 py-3 sm:py-4 rounded-xl2 border-2 bg-surface text-lg sm:text-2xl font-semibold cursor-default
      ...
      <main className="min-h-screen flex flex-col items-center px-4 sm:px-6 py-6 sm:py-8 gap-4 sm:gap-6">
        ...
        <div className="w-full max-w-xl flex flex-col gap-3">
          ...
          <input
            ...
            onPaste={(e) => e.preventDefault()}
            placeholder="R$ 0,00"
            className="w-full px-4 py-3 sm:py-4 rounded-xl2 border-2 border-accent bg-surface cursor-default
    ...
    <main className="min-h-screen flex flex-col items-center px-4 sm:px-6 py-6 sm:py-8 gap-4 sm:gap-6">
      ...
      <div className="w-full max-w-6xl flex flex-col gap-3">
        <input
          ...
          className={`w-full px-4 py-3 sm:py-4 rounded-xl2 border-2 bg-surface cursor-default
                     text-base sm:text-xl font-bold text-white placeholder:text-muted placeholder:font-semibold outline-none
                     ${buscaAtiva ? "border-accent" : "border-white/10"}`}
        />
        {buscaAtiva && (
          <TecladoVirtual
            valor={busca}
            onChange={setBusca}
            maxLength={60}
            onConfirmar={() => setBuscaAtiva(false)}
            labelConfirmar="FECHAR TECLADO"
          />
        )}
      </div>
