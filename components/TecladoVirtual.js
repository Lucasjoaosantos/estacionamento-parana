    ...
    <div className="w-full flex flex-col gap-6">
          ...
          <div className="grid grid-cols-[repeat(13,minmax(0,1fr))] gap-2">
            {linha1.map((tecla) => (
              <button
                ...
                className="h-24 rounded-xl2 bg-surface text-ink text-4xl font-bold
      ...
      <div className="grid grid-cols-3 gap-3">
        <button
          type="button"
          onClick={limpar}
          className="h-24 rounded-xl2 bg-danger text-white text-4xl font-bold"
        >
          LIMPAR
        </button>
        <button
          type="button"
          onClick={apagar}
          className="h-24 rounded-xl2 bg-surface border-2 border-white/10 text-ink text-4xl font-bold"
        >
          ⌫ APAGAR
        </button>
        {onConfirmar && (
          <button
            type="button"
            onClick={onConfirmar}
            className="h-24 rounded-xl2 bg-accent2 text-white text-4xl font-bold"
          >
            {labelConfirmar}
          </button>
        )}
