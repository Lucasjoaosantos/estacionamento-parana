    ...
    <div className="w-full flex flex-col gap-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        <button
          type="button"
          onClick={limpar}
          className="h-20 rounded-xl2 bg-danger text-white text-4xl font-bold"
        >
          LIMPAR
        </button>
        <button
          type="button"
          onClick={apagar}
          className="h-20 rounded-xl2 bg-surface border-2 border-white/10 text-ink text-4xl font-bold"
        >
          ⌫ APAGAR
        </button>
        {onConfirmar && (
          <button
            type="button"
            onClick={onConfirmar}
            className="h-20 rounded-xl2 bg-accent2 text-white text-4xl font-bold"
          >
            {labelConfirmar}
          </button>
        )}
